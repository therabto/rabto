    ...
    if(id){
      let data= {
               ...
               serviceOrProductIdToAdd:id
                ...
                AddaServiceOrProductTOStallHandler("POST",data).then(res=>{console.log(" add stall products response",res);handleModalClose();getStallHandler()})
    }
  }
    ...
    if(stallProfile){
      let data= {
               ...
               serviceOrProductIdToRemove:id
                ...
                RemoveaServiceOrProductTOStallHandler("POST",data).then(res=>{console.log(" stall products response",res);getStallHandler();})
    }
  }
